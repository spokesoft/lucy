...
/// <summary>
/// Validator for the 'add ticket' command.
/// </summary>
internal class AddTicketCommandValidator(
    IUnitOfWork unitOfWork,
    IStringLocalizer<Program> localizer) : ICommandValidator<AddTicketCommand>
{
    private readonly IUnitOfWork _uow = unitOfWork;
    private readonly IStringLocalizer<Program> _localizer = localizer;

    public async Task<ValidationResult> ValidateAsync(CommandContext context, AddTicketCommand command, CancellationToken token = default)
    {
