...
/// <summary>
/// Validator for the <see cref="ListStatusesCommand"/> command.
/// </summary>
internal class ListStatusesCommandValidator(
    IMediator mediator) : ICommandValidator<ListStatusesCommand>
{
