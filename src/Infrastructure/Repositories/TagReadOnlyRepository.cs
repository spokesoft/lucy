...
/// <summary>
/// Tag read-only repository implementation
/// </summary>
public class TagReadOnlyRepository(
    LucyReadContext context) : ReadOnlyRepositoryBase<Tag, long>(context), ITagReadOnlyRepository
{
    /// <inheritdoc />
