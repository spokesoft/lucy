...
/// <summary>
/// Comment read-only repository implementation
/// </summary>
public class CommentReadOnlyRepository(
    LucyReadContext context) : ReadOnlyRepositoryBase<Comment, long>(context), ICommentReadOnlyRepository
{
    /// <summary>
