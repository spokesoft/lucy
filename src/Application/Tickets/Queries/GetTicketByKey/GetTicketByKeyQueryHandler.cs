...
/// <summary>
/// Handler for getting a ticket by its key.
/// </summary>
public class GetTicketByKeyQueryHandler(
    IReadOnlyUnitOfWork unitOfWork) : IRequestHandler<GetTicketByKeyQuery, TicketDto?>
{
    /// <summary>
